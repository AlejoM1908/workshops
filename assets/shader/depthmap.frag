...
// http://alejom1908.github.io/Transformations/#/6/14 and:
// http://alejom1908.github.io/Transformations/#/6/15
// yielding to: z_e = (2 * near * far) / (z_n * (far - near) - far - near) (eq1)

uniform float near;
uniform float far;

// remapping of a value among 2 ranges: http://alejom1908.github.io/Transformations/#/7/1
